...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    "new.scanWarning": "Scanned code does not look like VIN or VIS. Find VIN/VIS and scan it, or enter it manually.",
  ...
  sk: {
    ...
    "new.scanWarning": "Naskenovany kod nevyzera ako VIN alebo VIS. Najdi VIN/VIS a naskenuj ho, alebo ho napis rucne.",
  ...
  hu: {
    ...
    "new.scanWarning": "A beolvasott kod nem VIN vagy VIS. Keresd meg a VIN/VIS kodot es olvasd be, vagy ird be kezzel.",
